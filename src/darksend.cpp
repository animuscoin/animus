...
{
    if(fLiteMode) return; // ignore all Animus related functionality
...
/*
    ...
    allow endless transaction that would bloat Animus and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("animus-privatesend");
