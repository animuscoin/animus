    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Animus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Animus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and animus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Animus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Animus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Animus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Animus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Animus addresses"));
    ...
    openAction->setStatusTip(tr("Open a animus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Animus Core help message to get a list with possible Animus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Animus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Animus network", "", count));
}
...
{
    QString strTitle = tr("Animus Core"); // default title
