    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ANS-light"), QVariant("light"));
    ui->theme->addItem(QString("ANS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ANS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ANS-traditional"), QVariant("trad"));
