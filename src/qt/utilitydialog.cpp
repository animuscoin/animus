    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Animus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Animus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  animus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Animus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ANS, 0.1 ANS, 1 ANS and 10 ANS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://animuscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://animuscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Animus Core is shutting down...") + "<br /><br />" +
