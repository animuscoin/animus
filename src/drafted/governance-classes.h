 ...
 *
 *   // network
 *   CAnimusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.animuscoin.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAnimusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AnimusNetwork
// //   -- signature requirements : Key1(User)
// class CAnimusNetworkVariable : public CGovernanceObject
// {
// private:
