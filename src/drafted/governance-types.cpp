...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AnimusNetwork") type = AnimusNetwork;
    if(strType == "AnimusNetworkVariable") type = AnimusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AnimusNetwork) s = "AnimusNetwork";
    if(type == AnimusNetworkVariable) s = "AnimusNetworkVariable";
