...
* animus.conf: contains configuration settings for animusd or animus-qt
* animusd.pid: stores the process id of animusd while running
...
* debug.log: contains debug information and general logging generated by animusd or animus-qt
