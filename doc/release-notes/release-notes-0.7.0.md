Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/animus/files/Bitcoin/animus-0.7.0/

We recommend that everybody running prior versions of animusd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/animuscoin/animus/tarball/v0.7.0  # .tar.gz
  https://github.com/animuscoin/animus/zipball/v0.7.0  # .zip
...
in your terminal, then install the animus-qt package:
  sudo apt-get install animus-qt
...
Core animus handling and blockchain database
...
* Ensure a changed animus unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for animus-qt.exe
* (Windows only): add meta-data to animus-qt.exe (e.g. description)
...
* Bash programmable completion for animusd(1)
