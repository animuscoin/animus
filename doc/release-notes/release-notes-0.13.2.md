Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://animus.org/bin/animus-core-0.13.2/>
...
- #8908 `4a974b2` Update animus-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow animus-tx to create v2 transactions (btcdrak)
