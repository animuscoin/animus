Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://animus.org/bin/animus-core-0.11.0/>
...
For example, add the following to `animus.conf`:
...
related to the blockchain in the animus system: the raw blocks as received over 
...
For an example script see [animus-submittx](https://github.com/laanwj/animus-submittx).
...
- #5334 `cf87536` libanimusconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new animus-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add animus logo to about screen
...
- #5809 `46bfbe7` Add animus-cli man page
...
- #5849 `41259ca` contrib/init/animusd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for animus-tx)
